...
public class EnumerarLineas extends JPanel
    ...
    public EnumerarLineas(JTextComponent component) {
        this(component, 3);
    }

    
    public EnumerarLineas(JTextComponent component, int minimumDisplayDigits) {
